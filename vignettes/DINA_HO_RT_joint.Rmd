...
```{r}
output_HMDCM_RT_joint = MCMC_learning(Y_sim,Q_matrix,"DINA_HO_RT_joint",test_order,Test_versions,100,30,
                                 Q_examinee = Q_examinee,Latency_array = L_sim, G_version = G_version,
