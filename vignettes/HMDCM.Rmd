...
pp_check(output_HMDCM, plotfun="dens_overlay", type="M1")
pp_check(output_HMDCM, plotfun="hist", type="M1")
pp_check(output_HMDCM, plotfun="stat_2d", type="M2")
